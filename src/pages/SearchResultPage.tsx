...
const SearchResultPage: FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
            {/* Header */}
            <header className="sticky top-0 z-30 bg-white border-b border-gray-100 mb-6">
                <div className="flex items-center gap-3 px-4 py-3 max-w-4xl mx-auto">
                    <button
                        onClick={() => navigate(-1)}
                        className="p-2 -ml-2 text-gray-600 hover:text-blue-600 transition-colors cursor-pointer"
                    >
                    ...
                    <div className="flex-1 relative">
                        <input
                            ...
                            className="w-full py-2.5 pl-10 pr-4 bg-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                    </div>
                    <button className="p-2 -mr-2 cursor-pointer text-gray-600 hover:text-blue-600">
